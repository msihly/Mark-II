...
import { Bookmark, TagOption, useStores } from "store";
...
import { editBookmarkTags } from "database";
...
export const Tagger = observer(({ bookmarks, hasFocusOnOpen = false }: TaggerProps) => {
        ...
        <>
          <DialogContent dividers className={css.dialogContent}>
            <View column>
              ...
              <TagInput value={tagStore.getTagCounts(bookmarks)} disabled opaque />
